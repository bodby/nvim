...
hl(0, "DashboardKey", { fg = c.purple_b, bold = true })
hl(0, "DashboardLogo", { fg = c.white_c })
hl(0, "DashboardFooter", { fg = c.white_c, italic = true })
...
hl(0, "StatusLineNC", { bg = c.gray_c })
hl(0, "StatusLineSep", { fg = c.gray_a, bg = c.gray_c })
hl(0, "StatusLineMode", { fg = c.gray_c, bg = c.white_a })
hl(0, "StatusLinePos", { fg = c.white_b, bg = c.gray_c })
hl(0, "StatusLineMacro", { fg = c.purple_b, bg = c.gray_c, bold = true })
hl(0, "StatusLineFile", { fg = c.white_b, bg = c.gray_c })
hl(0, "StatusLineMod", { fg = c.white_a, bg = c.gray_c })
hl(0, "StatusLineError", { fg = c.purple_b, bg = c.gray_c })
hl(0, "StatusLineWarning", { fg = c.blue_b, bg = c.gray_c })
...
-- TODO: Darker?
hl(0, "ColorColumn", { bg = c.gray_b })
hl(0, "SignColumn", { fg = c.gray_a })
hl(0, "CursorLine", { bg = c.gray_b })
hl(0, "CursorLineNr", { fg = c.white_a, bg = c.gray_c, bold = true })
hl(0, "Pmenu", { bg = c.gray_d })
hl(0, "PmenuSbar", { bg = c.gray_d })
hl(0, "PmenuThumb", { bg = c.gray_c })
hl(0, "PmenuSel", { bg = c.gray_b, bold = true })
-- TODO: Tabline.
...
-- Nix
hl(0, "@constant.builtin.nix", { fg = c.blue_a })
